...
class PermissionTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(
            title="Owner course", description="Description", price=1000, owner=self.user
        )
    ...
    def test_user_can_update_own_course(self):
        ...
        response = self.client.patch(
            f"/api/courses/{self.course.id}/", {"title": "Changed"}
        )
    ...
    def test_moderator_can_update_course(self):
        ...
        response = self.client.patch(
            f"/api/courses/{self.course.id}/", {"title": "Moderator changed"}
        )
    ...
    def test_moderator_cannot_create_course(self):
        ...
        response = self.client.post(
            "/api/courses/",
            {"title": "Moderator course", "description": "Test", "price": 2000},
        )
